...
public class ManageCategory extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (isEmpty()) {
            ...
            if (cat.isIDExists(id)) {
                ...
                JOptionPane.showMessageDialog(this, "Category id does not exists", "Warning", 2);
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (jTextField2.getText().isEmpty()) {
            ...
            if (cat.isIDExists(id)) {
                ...
                JOptionPane.showMessageDialog(this, "Category does not exists", "Warning", 2);
            }
        }
    ...
    private static class AdminDashboardjPanel7 {

        private static void setBackground(Color primaryColor) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }

        public AdminDashboardjPanel7() {
        }
    }

    private static class AdminDashboardjLabel5 {

        private static void setVisible(boolean b) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }

        public AdminDashboardjLabel5() {
        }
    }
}
